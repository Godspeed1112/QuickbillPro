...
const ManageCustomers: React.FC<ManageCustomersProps> = ({ 
          ...
          <View style={{ 
            ...
            <TouchableOpacity
              style={[currentStyles.actionButton, { 
                flex: 1, 
                backgroundColor: isImporting ? '#9ca3af' : '#059669',
  ...
  style={{
    flexDirection: 'row',
    marginTop: 20, // Keeps spacing from the list
    gap: 12,
    borderTopWidth: 1,
    borderTopColor: isDarkMode ? '#4b5563' : '#e5e7eb', // Keeps border separation
    paddingTop: 20, // Matches your first version's padding
  }}
>
  <TouchableOpacity
    style={[
  ...
  return (
    <View style={{ flex: 1, backgroundColor: isDarkMode ? '#1d4377ff' : '#f3f4f6' }}>
      {/* Header */}
        ...
        {activeTab === 'customers' ? (
          <>
            ...
            <View style={{ flexDirection: 'row', marginBottom: 16, gap: 8 }}>
              ...
              <TouchableOpacity
                style={[currentStyles.actionButton, { flex: 1, backgroundColor: '#7c3aed' }]}
                onPress={loadContacts}
                disabled={isLoadingContacts}
              >
                <Feather name={isLoadingContacts ? "loader" : "user-plus"} size={16} color="white" />
                <Text style={currentStyles.actionButtonText}>
                  {isLoadingContacts ? 'Loading...' : 'From Contacts'}
                </Text>
              </TouchableOpacity>
            </View>

            <TouchableOpacity
              style={[currentStyles.actionButton, { backgroundColor: '#ea580c', marginBottom: 16 }]}
              onPress={importFromCSV}
            >
              <Feather name="upload" size={16} color="white" />
              <Text style={currentStyles.actionButtonText}>Import from CSV</Text>
            </TouchableOpacity>
